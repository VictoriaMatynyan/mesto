...
export default class PopupWithForm extends Popup {
    constructor(popup, handleFormSubmit) {
        ...
        this._popupForm = this.popup.querySelector('.popup__input-form');
        this._inputList = Array.from(this._popupForm.querySelectorAll(formStateObj.inputElement));
    }
    
    //получаем значения всех полей формы
    _getInputValues() {
        //создаём пустой объект для сбора данных. Этот метод собирает массив всех полей в форме, обходит их и добавляет их значения в объект. 
        this._formValues = {};
