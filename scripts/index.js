...
const popupEditOpener = document.querySelector('.profile__popup-open_edit').addEventListener('click', () => {
    addPopupStatus(popupEdit);
    popupInputName.value = profileName.textContent;
    popupInputDescription.value = profileDescription.textContent;
})

const popupAddOpener = document.querySelector('.profile__popup-open_add').addEventListener('click', () => addPopupStatus(popupAdd));
